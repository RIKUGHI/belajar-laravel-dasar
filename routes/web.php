...
Route::get('/eskrim', function() {
    return 'Es krimnya enak';
});

Route::redirect('/youtube', '/eskrim');

Route::fallback(function(){
    return '404 by eskrim';
});

Route::view('/hello', 'hello', ['name' => 'Bambang']);

Route::get('/hello-again', function(){
    return view('hello', ['name' => 'Bambang-again']);
});

Route::get('/hello-world', function(){
    return view('hello.world', ['name' => 'Bambang']);
});
...
Route::get('/conflict/bambang', function(){
    return "Conflict bambang nice";
});
...
Route::get('/redirect/named', function () {
    // return route('redirec-hello', ['name' => 'bambang']);
    // return url()->route('redirect-hello', ['name' => 'bambang']);
    return URL::route('redirect-hello', ['name' => 'bambang']);
});
...
Route::middleware(['contoh:GHI,401'])->prefix('/middleware')->group(function(){
    Route::get('/api', function(){
        return 'OK';
    })->middleware(['contoh:GHI,401']);
